...
def get_co2_fig(csv_data):
    ...
    fig.add_trace(go.Scatter(name='', x=[timestamp[-1]], y=[co2_ppm[-1]], marker=dict(size=6, color='crimson')))
    fig.add_trace(go.Scatter(name='', x=[timestamp[-1]], y=[t_celsius[-1]], marker=dict(size=6, color='royalblue'), yaxis="y2"))
    fig.add_trace(go.Scatter(name='', x=[timestamp[-1]], y=[p_hpa[-1]], marker=dict(size=6, color='tomato'), yaxis="y3"))
    fig.add_trace(go.Scatter(name='', x=[timestamp[-1]], y=[h_percent[-1]], marker=dict(size=6, color='teal'), yaxis="y4"))
